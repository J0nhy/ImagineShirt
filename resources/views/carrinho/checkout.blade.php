 ...
 <script>
     ...
     function hideFields() {
         ...
         paymentTxt.innerHTML =
             "{{ $customer->default_payment_type ?? '' }} <i class='zmdi zmdi-chevron-down icon' style='vertical-align: middle;'></i>";
 ...
 @section('main')
     <div class="checkout-container">
         ...
         <!-- Shoping Cart -->
         <form class="bg0 p-t-75 p-b-85 background" method="POST" action="store" style="padding-bottom: 0%;"
                 ...
                 <div class="row">
                         ...
                         <div class="m-l-25 m-r--38 m-lr-0-xl">
                             <div class="table-shopping-cart">
                                 @if ($customer->address != null)
                                     <div id="existingAddress" onclick="hideFields()"
                                         class="customShirtBack width44 Padding5 myBlowAnim marginb5 dis-inline-block marginr5 size-304">
                                         ...
                                         <h5 class="linkBranco">Forma de Pagamento: {{ $customer->default_payment_type }}
                                         </h5>
                                     </div>
                                     <div id="newAddress" onclick="showFields()" style="vertical-align: top"
                                         class="customShirtBack width44 Padding5 myBlowAnim marginb5 dis-inline-block size-304">
                                 ...
                                 <div id="fields" class="<?php $customer->address != null ? 'hidden' : ''; ?>">
                                     ...
                                     <input type="text" class="inputText width30 dis-inline marginb8" name="NIF"
                                         id="NIF" min="1" max="9" placeholder="NIF">
                                     <input type="text" class="inputText width80" name="Morada" id="Morada"
                                         min="10" max="100" placeholder="Morada" required>
                                     <input type="text" class="inputText width30 dis-inline marginr5" name="cod"
                                         id="cod" min="8" max="8" placeholder="Codigo Postal">
                                     <input type="text" class="inputText width44 dis-inline marginb8" name="Localidade"
                                         id="Localidade" min="10" max="40" placeholder="Localidade">
                                     <input type="text" class="inputText width80" name="Descricao" id="Descricao"
                                         min="1" max="200" placeholder="Observações">
                                     <input class="dis-inline" style="transform : scale(1.5); cursor: pointer;"
                                         type="checkbox" name="saveData" id="saveData">
                                     <h5 class="dis-inline linkBranco"> Definir estes dados como principais </span>
                                 </div>
                             </div>
                         </div>
                     </div>
                     ...
                     <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                         ...
                         <div id="checkout" class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                             ...
                             <div class="flex-w flex-t p-t-27 p-b-33">
                                 ...
                                 <div class="p-t-33 width44 dis-inline">
                                     <div class="dropdown dis-inline" style="float: left;">
                                         <div class="select">
                                             <span style="color:black !important;" id="paymentTxt">Pagamento <i
                                                     class="zmdi zmdi-chevron-down icon"
                             ...
                             @if (Auth::user())
                                 <button id="btnSubmit"
                                     class="flex-c-m stext-101 cl2 size-116 bg8 bor14 hov-btn3 p-lr-15 trans-04 pointer"
                                     type="button" onclick="verificacao()">
                                     Place Order
                                 </button>
                             @else
                                 <a class="flex-c-m stext-101 cl2 size-116 bg8 bor14 hov-btn3 p-lr-15 trans-04 pointer"
