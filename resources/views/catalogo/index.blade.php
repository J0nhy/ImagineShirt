                ...
                <div class="row background">
                    ...
                    <div class="expansivel background" id="minhaDiv">
                        <div class="ver-mais background">
                            @if (count($imagensPrivadas) >= 1)
                                @foreach ($imagensPrivadas as $tshirt)
                                    <div class="col-4 imgCardBack">
                                        ...
                                        <div>
                                            ...
                                            <button
                                                class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer buttonCards">
                                                <a href="{{ route('catalogo.show', ['tshirt' => $tshirt]) }}"
                                                    class="buttonCards" style="text-decoration: none;">Personalizar <i
                                                        class="zmdi zmdi-chevron-right icon"></i></a>
                                            </button>
                                        </div>
                                    </div>
                                    <br>
                                @endforeach()
                            @else
                                <h4>Ainda não adicionou imagens próprias.</h4>
                            @endif
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="col-4 imgCardBack">
                        ...
                        <div>
                            ...
                            <button
                                class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer buttonCards">
                                <a href="{{ route('catalogo.show', ['tshirt' => $tshirt]) }}" class="buttonCards"
                                    style="text-decoration: none;">Personalizar <i
                                        class="zmdi zmdi-chevron-right icon"></i></a>
                            </button>
                        </div>
                    </div>
